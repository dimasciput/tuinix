...
Thank you for your interest in contributing to tuinix (the "Project")! This Contributor License Agreement ("Agreement") documents the rights granted by contributors to the Project, ensuring that your valuable contributions are properly protected and can be used to benefit the entire community.
...
"I agree to the terms of the Contributor License Agreement for the tuinix project."

## Contributors

By contributing to this project, the following individuals have agreed to the CLA:

- Tim Sutton (timlinux) - Original author and maintainer

---

*This CLA is based on the Apache Software Foundation's Individual Contributor License Agreement.*