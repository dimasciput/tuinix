...
[![Pull Requests](https://img.shields.io/github/issues-pr/timlinux/tuinix.svg)](https://github.com/timlinux/tuinix/pulls)

</div>

A terminal-centric Linux distribution built on NixOS with ZFS encryption. No desktop environment, no window manager -- just a carefully curated set of terminal tools on a reproducible, declarative foundation.
...
Best for testing or trying tuinix without touching your hardware. Key requirements:
...
**Built by [Tim Sutton](https://github.com/timlinux) and the tuinix community.**
